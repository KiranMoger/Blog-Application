...
public class UserController {
	...
	ResponseEntity<?> getUserProfile(@AuthenticationPrincipal CustomUserDetails userDetails) {//// Injects the currently authenticated user’s details directly from the Spring Security context
	...
	// Specifies that this API accepts multipart/form-data requests (used for file upload + form data)
